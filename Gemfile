...
gem 'faker',                  '~> 2.17.0'
# See https://github.com/amrfaissal/googlemaps-services/pull/13
# gem 'googlemaps-services',    '> 1.5.0'
gem 'googlemaps-services', git: 'https://github.com/jrmhaig/googlemaps-services', branch: 'update_http'
